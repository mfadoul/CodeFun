package gmu.masters.swe637.hw10.geometry.omd;
 ...
 *   
 *   For this mutation, the overriding method getLength() will be removed.
 */
...
public class LineSegment3D extends LineSegment2D {
	...
	// OMD Mutation: removing this method so that calls always use the parent
	// version: LineSegment2D.getLength().
